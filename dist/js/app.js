 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                priceSlider.noUiSlider.on("update", (function(values, handle) {
                    amount.value = " " + Math.round(values[0]) + " ₽ - " + Math.round(values[1]) + " ₽";
                }));
            }
        }
        rangeInit();
        ...
        function initSliders() {
            ...
            let swiperSingle = new core(".vertical-tab-nav", {
                modules: [ Thumb, Zoom, Navigation ],
                slidesPerView: 3,
                spaceBetween: 10,
                speed: 1500,
                freeMode: true,
            ...
            new core(".product-thumb-carousel", {
                modules: [ Thumb, Zoom ],
                zoom: true,
                slidesPerView: 1,
                spaceBetween: 10,
...
***************************************************************************** */
        ...
        new smooth_scroll_polyfills_min('.menu__item a[href*="#"]', {
            header: ".header"
        });
        ...
        if (dws && footer) {
            function checkOffset() {
                ...
                if (getRectTop(dws) + document.body.scrollTop + dws.offsetHeight >= getRectTop(footer) + document.body.scrollTop) dws.style.position = "absolute";
                if (document.body.scrollTop + window.innerHeight < getRectTop(footer) + document.body.scrollTop) dws.style.position = "fixed";
            }
        ...
        if (viewItemClick && productWrapper) viewItemClick.addEventListener("click", (function(event) {
            let but = event.target.parentNode;
            let productViewMode = document.querySelector(".product-view-mode");
            if (productViewMode.querySelector(".active")) productViewMode.querySelector(".active").classList.remove("active");
